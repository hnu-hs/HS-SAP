...
class StockIndex:
    ...
    def __init__(self):
       ...
       #股票测试路径
       self.gptime_path   = "\\Data\\History\\Stock\\股票时间数据\\股票交易日期"
       
       self.sztime_path   = "\\Data\\History\\Stock\\股票时间数据\\上证交易日期"
       
       self.gp_path       = "\\Data\\History\\Stock\\"

       self.gpdata_path   = "\\Data\\History\\Stock\\股票历史数据"
       
       self.gpmissdata_path = "\\Data\\History\\Stock\\股票缺失数据\\"
       
       self.tpdata_path   = "\\Data\\History\\Stock\\股票时间数据\\股票停牌日期\\"
       
       
       #股票起始时间
       self.gpdate        = "2000/01/05"
       
       # 板块起始时间
       self.bkdate        = "2000/01/05"
   ...
   # 获取板块时间数据             
    ...
    def getStockIndexFile(self,bkpath):
    ...
    def getStockIndexTradingTime(self,lf): 
    ...
    def getStockMissdata(self,dkey,misset,path): 
        
        filestr = path+"missingdata"+".txt"
    ...
    def stockIndexTickHandle(self,boardindex,bktimedict):
        ...
        engine = create_engine('mysql://root:1234@127.0.0.1/stocksystem?charset=utf8')
